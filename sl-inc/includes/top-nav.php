...
<div style='padding:7px'><strong style='font-size:1.0em'>A.</strong>&nbsp;<b>Introducing:</b> <a href='http://www.viadat.com/products-page/early-access-entry/' target='_blank'>Early Access</a>: Multiple stages of benefits to you, our users -- earliest joiners reap the highest future benefits</div> 
<div style='background-color:lightYellow; /*border-top:solid gold 1px; border-bottom:solid gold 1px; */padding:7px'><strong style='font-size:1.0em'>B.</strong>&nbsp;<b><a href='http://docs.viadat.com/Addons_Platform_Lite' target='_blank'>Addons Platform Lite</a>:</b> Much of the power of the full Addons Platform, minus the Addons Marketplace.  Now you have the flexibility to buy addons as you need.</div>
