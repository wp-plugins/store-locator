...
print "<span style='padding-left:10px; color:gray; position:relative; top:10px; font-size:11px; cursor:help;' title='".__("Store Locator Version", SL_TEXT_DOMAIN)." $sl_version ".__("and", SL_TEXT_DOMAIN)." ".__("PHP Version", SL_TEXT_DOMAIN)." ".phpversion()."'>SL v$sl_version{$sl_update_msg}&nbsp;|&nbsp;PHP v".phpversion()."</span></ul>\n";
...
(<a href='".$_SERVER['REQUEST_URI']."&sl_a_s_v3=1'>".__("Hide Message", SL_TEXT_DOMAIN)."</a>)
 ...
 ".__("<b style='font-size:1.3em'><br>LotsOfLocales&trade; Addons Platform</b>
