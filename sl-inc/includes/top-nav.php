...
print "<span style='padding-left:10px; color:gray; position:relative; top:10px; font-size:11px; cursor:help;' title='Store Locator Version $sl_version and PHP Version ".phpversion()."'>SL $sl_version{$sl_update_msg}&nbsp;|&nbsp;PHP ".phpversion()."</span></ul>\n";
