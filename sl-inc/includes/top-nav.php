...
if (empty($sl_vars['csv_imp_msg']) || $sl_vars['csv_imp_msg'] != 'hide') {
	...
	$csv_needs_mod = ( (file_exists(SL_ADDONS_PATH."/csv-xml-importer-exporter/csv-xml-importer-exporter.php") || file_exists(SL_ADDONS_PATH."/csv-importer-exporter-g2/csv-importer-exporter-g2.php") ) && strnatcmp(phpversion(), '5.3.9') >= 0 && $max_input_default);
