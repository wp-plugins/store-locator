...
$sl_api = plugins_api('plugin_information', array('slug' => 'store-locator', 'fields' => array('sections' => true) ) );
//var_dump($sl_api); die();
...
$sl_update_msg = ($sl_latest_version > $sl_version)? "&nbsp;|&nbsp;<a href='$sl_update_link_nonce' style='color:#900; font-weight:bold;' onclick='confirmClick(\"You will now be updating to Store Locator v$sl_latest_version, click OK or Confirm to continue.\", this.href); return false;'>Update to $sl_latest_version</a>" : "" ;
