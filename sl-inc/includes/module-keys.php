...
<input class='button-primary' type='button' value='".__("Activate", SL_TEXT_DOMAIN)."' onclick=\"showLoadImg('show', 'module-keys');validate_addons(document.getElementById('licenseForm')); return false;\">&nbsp;&nbsp;";
} else {
	print "<strong>No addons have been uploaded to your website yet</strong><br> <small>(<strong>Addons Directory</strong>: /".str_replace(ABSPATH, "", SL_ADDONS_PATH).")</small> <br><br>";
}

print __("Looking for more addons & themes", SL_TEXT_DOMAIN)."? <a href='http://www.viadat.com/products-page/' target='_blank'>".__("They're all right here", SL_TEXT_DOMAIN)."</a><br><br>
