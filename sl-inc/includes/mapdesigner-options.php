...
###Labels###
$sl_mdo[] = array("field_name" => "search_label", "default" => "Address", "input_zone" => "labels", "label" => __("Address Input", SL_TEXT_DOMAIN), "input_template" => "<input name='search_label' value=\"$sl_vars[search_label]\" size='14'>");
$sl_mdo[] = array("field_name" => "radius_label", "default" => "Radius", "input_zone" => "labels", "label" => __("Radius Dropdown", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_radius_label' value=\"$sl_vars[radius_label]\" size='14'>");
$sl_mdo[] = array("field_name" => "website_label", "default" => "Website", "input_zone" => "labels", "label" => __("Website URL", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_website_label' value=\"$sl_vars[website_label]\" size='14'>");

$sl_mdo[] = array("field_name" => "directions_label", "default" => "Directions", "input_zone" => "labels", "label" => __("Directions URL", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_directions_label' value=\"$sl_vars[directions_label]\" size='14'>");
$sl_mdo[] = array("field_name" => "instruction_message", "default" => "Enter Your Zip Code or Address Above.", "input_zone" => "labels", "label" => __("Instruction to Users", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_instruction_message' value=\"".$sl_vars['instruction_message']."\" size='14'>", "stripslashes" => 1);
$sl_mdo[] = array("field_name" => "city_dropdown_label", "default" => "--Search By City--", "input_zone" => "labels", "label" => __("City Dropdown", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_city_dropdown_label' value=\"".$sl_vars['city_dropdown_label']."\" size='14'>", "stripslashes" => 1);

$sl_mdo[] = array("field_name" => "location_not_found_message", "default" => "", "input_zone" => "labels", "label" => __("Location Doesn't Exist", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_location_not_found_message' value=\"".$sl_vars['location_not_found_message']."\" size='14'>", "stripslashes" => 1);
$sl_mdo[] = array("field_name" => "no_results_found_message", "default" => "No Results Found", "input_zone" => "labels", "label" => __("No Results Are Found", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_no_results_found_message' value=\"".$sl_vars['no_results_found_message']."\" size='14'>", "stripslashes" => 1);
$sl_mdo[] = array("field_name" => "hours_label", "default" => "Hours", "input_zone" => "labels", "label" => __("Hours", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_hours_label' value=\"".$sl_vars['hours_label']."\" size='14'>");

$sl_mdo[] = array("field_name" => "phone_label", "default" => "Phone", "input_zone" => "labels", "label" => __("Phone", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_phone_label' value=\"".$sl_vars['phone_label']."\" size='14'>");
$sl_mdo[] = array("field_name" => "fax_label", "default" => "Fax", "input_zone" => "labels", "label" => __("Fax", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_fax_label' value=\"".$sl_vars['fax_label']."\" size='14'>");
$sl_mdo[] = array("field_name" => "email_label", "default" => "Email", "input_zone" => "labels", "label" => __("Email", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_email_label' value=\"".$sl_vars['email_label']."\" size='14'>");
###End Labels###

###Dimensions###
$sl_mdo[] = array("field_name" => "zoom_level", "default" => "4", "input_zone" => "dimensions", "label" => "<nobr>".__("Zoom Level", SL_TEXT_DOMAIN)."</nobr>", "input_template" => $zoom);
$sl_mdo[] = array("field_name" => array("height", "width", "height_units", "width_units"), "default" => array("350", "100", "px", "%"), "input_zone" => "dimensions", "label" => "<nobr>".__("Map Dimensions (H x W)", SL_TEXT_DOMAIN)."</nobr>", "input_template" => "<input name='height' value='$sl_vars[height]' size='3'>&nbsp;".sl_choose_units($sl_vars['height_units'], "height_units")." <span style='font-size:1.2em; vertical-align:middle'>X</span> <input name='width' value='$sl_vars[width]' size='3'>&nbsp;".sl_choose_units($sl_vars['width_units'], "width_units", ""), "numbers_only" => array(1, 1, 0, 0)
);
