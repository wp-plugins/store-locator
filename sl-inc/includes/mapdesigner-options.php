...
###Labels###
$sl_mdo[] = array("field_name" => "search_label", "input_zone" => "labels", "label" => __("Address Input", SL_TEXT_DOMAIN), "input_template" => "<input name='search_label' value=\"$sl_search_label\" size='14'>");
$sl_mdo[] = array("field_name" => "radius_label", "input_zone" => "labels", "label" => __("Radius Dropdown", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_radius_label' value=\"$sl_radius_label\" size='14'>");
$sl_mdo[] = array("field_name" => "website_label", "input_zone" => "labels", "label" => __("Website URL", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_website_label' value=\"$sl_website_label\" size='14'>");

$sl_mdo[] = array("field_name" => "directions_label", "input_zone" => "labels", "label" => __("Directions URL", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_directions_label' value=\"$sl_directions_label\" size='14'>");
$sl_mdo[] = array("field_name" => "instruction_message", "input_zone" => "labels", "label" => __("Instruction to Users", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_instruction_message' value=\"".$sl_instruction_message."\" size='14'>", "stripslashes" => 1);
$sl_mdo[] = array("field_name" => "city_dropdown_label", "input_zone" => "labels", "label" => __("City Dropdown", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_city_dropdown_label' value=\"".$sl_city_dropdown_label."\" size='14'>", "stripslashes" => 1);

$sl_mdo[] = array("field_name" => "location_not_found_message", "input_zone" => "labels", "label" => __("Location Doesn't Exist", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_location_not_found_message' value=\"".$sl_location_not_found_message."\" size='14'>", "stripslashes" => 1);
$sl_mdo[] = array("field_name" => "no_results_found_message", "input_zone" => "labels", "label" => __("No Results Are Found", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_no_results_found_message' value=\"".$sl_no_results_found_message."\" size='14'>", "stripslashes" => 1);
$sl_mdo[] = array("field_name" => "hours_label", "input_zone" => "labels", "label" => __("Hours", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_hours_label' value=\"".$sl_hours_label."\" size='14'>");

$sl_mdo[] = array("field_name" => "phone_label", "input_zone" => "labels", "label" => __("Phone", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_phone_label' value=\"".$sl_phone_label."\" size='14'>");
$sl_mdo[] = array("field_name" => "fax_label", "input_zone" => "labels", "label" => __("Fax", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_fax_label' value=\"".$sl_fax_label."\" size='14'>");
$sl_mdo[] = array("field_name" => "email_label", "input_zone" => "labels", "label" => __("Email", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_email_label' value=\"".$sl_email_label."\" size='14'>");
###End Labels###

###Dimensions###
$sl_mdo[] = array("field_name" => "zoom_level", "input_zone" => "dimensions", "label" => "<nobr>".__("Zoom Level", SL_TEXT_DOMAIN)."</nobr>", "input_template" => $zoom);
$sl_mdo[] = array("field_name" => array("height", "width", "height_units", "width_units"), "input_zone" => "dimensions", "label" => "<nobr>".__("Map Dimensions (H x W)", SL_TEXT_DOMAIN)."</nobr>", "input_template" => "<input name='height' value='$sl_height' size='3'>&nbsp;".sl_choose_units($sl_height_units, "height_units")." <span style='font-size:1.2em; vertical-align:middle'>X</span> <input name='width' value='$sl_width' size='3'>&nbsp;".sl_choose_units($sl_width_units, "width_units", ""), "numbers_only" => array(1, 1, 0, 0)
);
