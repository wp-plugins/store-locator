...
$sl_map_type["".__("Normal", SL_TEXT_DOMAIN).""]="google.maps.MapTypeId.ROADMAP";
$sl_map_type["".__("Normal + Terrain (Physical)", SL_TEXT_DOMAIN).""]="google.maps.MapTypeId.TERRAIN";
$sl_map_type["".__("Satellite", SL_TEXT_DOMAIN).""]="google.maps.MapTypeId.SATELLITE";
$sl_map_type["".__("Satellite + Labels (Hybrid)", SL_TEXT_DOMAIN).""]="google.maps.MapTypeId.HYBRID";
$sl_map_type_options="";

foreach($sl_map_type as $key=>$value) {
	$selected2=($sl_vars['map_type']==$value)? " selected " : "";
	$sl_map_type_options.="<option value='$value' $selected2>$key</option>\n";
}
