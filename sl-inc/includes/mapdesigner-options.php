...
###Labels###
$sl_mdo[] = array("field_name" => "search_label", "default" => "Address", "input_zone" => "labels", "output_zone" => "sl_template", "label" => __("Address Input", SL_TEXT_DOMAIN), "input_template" => "<input name='search_label' value=\"$sl_vars[search_label]\" size='14'>");

$sl_mdo[] = array("field_name" => "radius_label", "default" => "Radius", "input_zone" => "labels", "output_zone" => "sl_template", "label" => __("Radius Dropdown", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_radius_label' value=\"$sl_vars[radius_label]\" size='14'>");

$sl_mdo[] = array("field_name" => "website_label", "default" => "Website", "input_zone" => "labels", "output_zone" => "sl_dyn_js", "label" => __("Website URL", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_website_label' value=\"$sl_vars[website_label]\" size='14'>");

$sl_mdo[] = array("field_name" => "directions_label", "default" => "Directions", "input_zone" => "labels", "output_zone" => "sl_dyn_js", "label" => __("Directions URL", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_directions_label' value=\"$sl_vars[directions_label]\" size='14'>");
...
$sl_mdo[] = array("field_name" => "hours_label", "default" => "Hours", "input_zone" => "labels", "output_zone" => "sl_dyn_js", "label" => __("Hours", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_hours_label' value=\"".$sl_vars['hours_label']."\" size='14'>");

$sl_mdo[] = array("field_name" => "phone_label", "default" => "Phone", "input_zone" => "labels", "output_zone" => "sl_dyn_js", "label" => __("Phone", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_phone_label' value=\"".$sl_vars['phone_label']."\" size='14'>");

$sl_mdo[] = array("field_name" => "fax_label", "default" => "Fax", "input_zone" => "labels", "output_zone" => "sl_dyn_js", "label" => __("Fax", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_fax_label' value=\"".$sl_vars['fax_label']."\" size='14'>");

$sl_mdo[] = array("field_name" => "email_label", "default" => "Email", "input_zone" => "labels", "output_zone" => "sl_dyn_js",  "label" => __("Email", SL_TEXT_DOMAIN), "input_template" => "<input name='sl_email_label' value=\"".$sl_vars['email_label']."\" size='14'>");
###End Labels###
