...
function sl_head_scripts() {
	...
	if ($sl_vars['scripts_load'] == 'all' || $on_sl_page || is_search() || ((is_archive() || is_404()) && $sl_code_is_used_in_posts) || is_front_page() || is_single($post_ids_array) || !is_singular(array('page', 'attachment', 'post')) || function_exists('show_sl_scripts') || is_page_template()) {
