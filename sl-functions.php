...
if (!$ty['is_included']) {
	$ty['thanks_msg'] = __("<b>Like the Store Locator? Help guide others' decisions:</b><br><a href='#' class='star_button'>Give my review now</a> -- 2-3 sentences is plenty<br><br><b>Any problems? View:</b><br><a href='http://docs.viadat.com/' target='_blank'>Documentation</a> / <a href='http://www.viadat.com/contact/' target='_blank'>Contact us</a>", SL_TEXT_DOMAIN)."<br><br>";
	...
	$ty['thanks_msg'] = __("<b>Liking this? Help guide others' decisions:</b>&nbsp;<a href='#' class='star_button'>Give my review now</a> -- 2-3 sentences is plenty<br><b>Any problems? View:</b>&nbsp;<a href='http://docs.viadat.com/' target='_blank'>Documentation</a> / <a href='http://www.viadat.com/contact/' target='_blank'>Contact us</a>", SL_TEXT_DOMAIN)."<br><br>";
	$ty['thanks_msg_style'] = "";
	$ty['thanks_heading'] ="";
	$ty['action_call'] ="";
