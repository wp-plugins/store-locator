...
<tr><td><input name='search_label' value=\"$sl_search_label\"><br><span style='font-size:80%'>".__("Address Input Label", SL_TEXT_DOMAIN)."</span></td>
<td><input name='sl_radius_label' value=\"$sl_radius_label\"><br><span style='font-size:80%'>".__("Radius Dropdown Label", SL_TEXT_DOMAIN)."</span></td><!--/tr>
<tr--><td><input name='sl_website_label' value=\"$sl_website_label\"><br><span style='font-size:80%'>".__("Website URL Label", SL_TEXT_DOMAIN)."</span></td></tr>
<tr><td><input name='sl_directions_label' value=\"$sl_directions_label\"><br><span style='font-size:80%'>".__("Directions URL Label", SL_TEXT_DOMAIN)."</span></td>
<!--tr><td></td>
<td></td>
<tr><td></td>
<td></td>
