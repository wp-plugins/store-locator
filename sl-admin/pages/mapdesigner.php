...
print "<form method='post' name='mapDesigner'><table class='widefat' id='mapDesigner_table'><thead><tr><th colspan='2'>".__("MapDesigner&trade;", SL_TEXT_DOMAIN)." <div style='float:right'><small>".__("API Key", SL_TEXT_DOMAIN)." (<a rel='sl_pop' href='#api-key-info'>?</a>): </small>
...
<tr><td>".__("Number of Locations in Results", SL_TEXT_DOMAIN).":</td>
<td><input name='sl_num_initial_displayed' value='$sl_vars[num_initial_displayed]'><!--br><span style='font-size:80%'>(".__("Recommended Max: 50", SL_TEXT_DOMAIN).")</span--></td></tr>
...
<td><input name='sl_radius_label' value=\"$sl_radius_label\" size='16'><br><span style='font-size:80%'>".__("Radius Dropdown Label", SL_TEXT_DOMAIN)."</span></td><!--/tr>
<tr--><td><input name='sl_website_label' value=\"$sl_website_label\" size='16'><br><span style='font-size:80%'>".__("Website URL Label", SL_TEXT_DOMAIN)."</span></td></tr>
...
<tr><td></td>
<td></td>
<tr--><td colspan='2'><input name='sl_instruction_message' value=\"".$sl_instruction_message."\" size='40'><br><span style='font-size:80%'>".__("Instruction Message to Users", SL_TEXT_DOMAIN)."</span></td>
<!--td></td>
<td></td-->
</tr>
<tr><td>
...
<input name='sl_no_results_found_message' value=\"".$sl_no_results_found_message."\" size='40'><br><span style='font-size:80%'>".__("No Results Are Found Message", SL_TEXT_DOMAIN)."</span>
</td></tr>
</table>
