...
<tr id='scripts_load_selective_tr' $hidden_selective_tr><td>&nbsp;</td>
<td>".__("Also Load On", SL_TEXT_DOMAIN)." .. <input name='sl_scripts_load_home' value='1' type='checkbox' {$checked_home}>&nbsp;".__("Home", SL_TEXT_DOMAIN)."&nbsp;&nbsp;<input name='sl_scripts_load_archives_404' value='1' type='checkbox' {$checked_archives_404}>&nbsp;".__("Archives", SL_TEXT_DOMAIN)." / 404</td></tr>
...
<tr><td><input name='search_label' value=\"$sl_search_label\" size='14'><br><span style='font-size:80%'>".__("Address Input", SL_TEXT_DOMAIN)."</span></td>
<td><input name='sl_radius_label' value=\"$sl_radius_label\" size='14'><br><span style='font-size:80%'>".__("Radius Dropdown", SL_TEXT_DOMAIN)."</span></td><!--/tr>
<tr--><td><input name='sl_website_label' value=\"$sl_website_label\" size='14'><br><span style='font-size:80%'>".__("Website URL", SL_TEXT_DOMAIN)."</span></td></tr>
<tr><td><input name='sl_directions_label' value=\"$sl_directions_label\" size='14'><br><span style='font-size:80%'>".__("Directions URL", SL_TEXT_DOMAIN)."</span></td>
<!--tr><td></td>
<td></td>
<tr><td></td>
<td></td>
<tr--><td><input name='sl_instruction_message' value=\"".$sl_instruction_message."\" size='14'><br><span style='font-size:80%'>".__("Instruction to Users", SL_TEXT_DOMAIN)."</span></td>
<td>
<input name='sl_city_dropdown_label' value=\"".$sl_city_dropdown_label."\" size='14'><br><span style='font-size:80%'>".__("City Dropdown", SL_TEXT_DOMAIN)."</span>
</td><td colspan='2'>
</td>
<!--td></td-->
</tr>
<tr><td>
<input name='sl_location_not_found_message' value=\"".$sl_location_not_found_message."\" size='14'><br><span style='font-size:80%'>".__("Location Doesn't Exist", SL_TEXT_DOMAIN)."</span>
</td><td colspan='1'>
<input name='sl_no_results_found_message' value=\"".$sl_no_results_found_message."\" size='14'><br><span style='font-size:80%'>".__("No Results Are Found", SL_TEXT_DOMAIN)."</span>
</td><td>
<input name='sl_hours_label' value=\"".$sl_hours_label."\" size='14'><br><span style='font-size:80%'>".__("Hours", SL_TEXT_DOMAIN)."</span>
</td>
</tr>
<tr><td colspan='1'>
<input name='sl_phone_label' value=\"".$sl_phone_label."\" size='14'><br><span style='font-size:80%'>".__("Phone", SL_TEXT_DOMAIN)."</span>
</td><td colspan='1'>
<input name='sl_fax_label' value=\"".$sl_fax_label."\" size='14'><br><span style='font-size:80%'>".__("Fax", SL_TEXT_DOMAIN)."</span>
</td><td colspan='1'>
<input name='sl_email_label' value=\"".$sl_email_label."\" size='14'><br><span style='font-size:80%'>".__("Email", SL_TEXT_DOMAIN)."</span>
</td>
</tr>
</table>
</td></tr>
