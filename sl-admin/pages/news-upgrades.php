...
function sl_info_news(){
	print "<table width='100%'>
	<thead>
	<tr>
		<th onclick=\"show('sl_info_news'); return false;\" style='cursor:hand; cursor:pointer;'>".__("Latest News", SL_TEXT_DOMAIN)."</th>
	</tr>
	</thead>
	<tr>
		<td id='sl_info_news' style='display:none;'>
...
function sl_info_my_views(){
	print "
<table width='100%' height='350px'><thead><tr>
<th width=''>".
__("My Views", SL_TEXT_DOMAIN).
"</th></tr></thead>
<tr>
