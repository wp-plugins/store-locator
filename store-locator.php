...
echo '<tr><td class="plugin-update" colspan="5"><a href="http://www.viadat.com/vdl/store-locator.zip">Download the latest version</a> & upload it to your server.</td></tr>';
}
