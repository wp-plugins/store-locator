...
define('SL_ADDONS_PLATFORM_DIR', basename(current(glob(SL_ADDONS_PATH.'/*addons-platform*', GLOB_NOSORT))) );
...
//print("Exec. time: <br>".SL_ADDONS_PLATFORM_DIR."<br>".SL_ADDONS_PLATFORM_PATH ."<br>". SL_ADDONS_PLATFORM_BASE."<br>".SL_ADDONS_PLATFORM_FILE); die();
