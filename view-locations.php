...
foreach($_GET as $key=>$val) {
	...
	if ($key!="q" && $key!="o" && $key!="d" && $key!="changeView") {
...
<h2>".__("View Locations", $text_domain)."</h2></td><td align='right'><h2 style='float:right; padding-right:0px; width:100%'><input value='$_GET[q]' name='q'><input type='submit' value='Search' class='button'></h2>$hidden</td></tr></table></form><br>";
