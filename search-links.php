...
$extra_text=(!empty($_GET['q']))? __("for your search of", $text_domain)." <strong>\"$_GET[q]\"</strong>&nbsp;|&nbsp;<a href='$cleared'>".__("Clear&nbsp;Results", $text_domain)."</a>" : "" ;
?>
</td>
...
<?php 
	...
	if (!empty($_GET['u']) && !ereg("doSearch", $_GET['u'])) {
